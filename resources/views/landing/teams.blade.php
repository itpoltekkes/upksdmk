                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="team-card style3">
                        ...
                        <div class="team-hover-wrap">
                            ...
                            <div class="team-content">
                                <h3 class="team-title"><a href="team-details.html">Ethan David</a></h3>
                                <span class="team-desig">Instructor</span>
                            </div>
                            <div class="team-info">
                                <span><i class="fal fa-file-check"></i>2 Courses</span>
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="team-card style3">
                        ...
                        <div class="team-hover-wrap">
                            ...
                            <div class="team-content">
                                <h3 class="team-title"><a href="team-details.html">Michael Richard</a></h3>
                                <span class="team-desig">Senior Instructor</span>
                            </div>
                            <div class="team-info">
                                <span><i class="fal fa-file-check"></i>2 Courses</span>
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="team-card style3">
                        ...
                        <div class="team-hover-wrap">
                            ...
                            <div class="team-content">
                                <h3 class="team-title"><a href="team-details.html">Linda Elizabeth</a></h3>
                                <span class="team-desig">Junior Instructor</span>
                            </div>
                            <div class="team-info">
                                <span><i class="fal fa-file-check"></i>2 Courses</span>
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="team-card style3">
                        ...
                        <div class="team-hover-wrap">
                            ...
                            <div class="team-content">
                                <h3 class="team-title"><a href="team-details.html">James Charlie</a></h3>
                                <span class="team-desig">Instructor</span>
                            </div>
                            <div class="team-info">
                                <span><i class="fal fa-file-check"></i>2 Courses</span>
